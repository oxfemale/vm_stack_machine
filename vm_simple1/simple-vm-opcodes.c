...
void op_int_tostring(struct svm *svm)
{
    ...
    //if (getenv("DEBUG_FLAG") != NULL) printf("INT_TOSTRING(Register %d)\n", reg);
...
void op_int_random(struct svm *svm)
{
    ...
    //if (getenv("DEBUG_FLAG") != NULL) printf("INT_RANDOM(Register %d)\n", reg);
...
void op_string_store(struct svm *svm)
{
    ...
    //if (getenv("DEBUG_FLAG") != NULL) printf("STRING_STORE(Register %d) = '%s'\n", reg, str);
...
void op_string_print(struct svm *svm)
{
    ...
    //if (getenv("DEBUG_FLAG") != NULL) printf("STRING_PRINT(Register %d)\n", reg);

    /* get the contents of the register */
    char *str = get_string_reg(svm, reg);

    /* print */
    //if (getenv("DEBUG_FLAG") != NULL) printf("[stdout] register R%02d => %s\n", reg, str);
    //else
        printf("%s", str);
...
void op_string_concat(struct svm *svm)
{
    ...
    //if (getenv("DEBUG_FLAG") != NULL) printf("STRING_CONCAT(Register:%d = Register:%d + Register:%d)\n",reg, src1, src2);
...
void op_string_system(struct svm *svm)
{
    ...
    //if (getenv("DEBUG_FLAG") != NULL) printf("STRING_SYSTEM(Register %d)\n", reg);
...
void op_string_toint(struct svm *svm)
{
    ...
    //if (getenv("DEBUG_FLAG") != NULL) printf("STRING_TOINT(Register:%d)\n", reg);
